...
st.title(':scroll: 배틀그라운드: 경기 정보 :scroll:')
st.header('WWCD 경기 정보 오신 것을 환영합니다! :sparkles:')
st.markdown(' ')
st.markdown(' ')
...
st.markdown(" 4월 27일부터 29일까지의 총 18번의 경기에서 얻어온 70만 개가 넘는 다양한 로그 데이터를 분석하여 신규 유저분들에게 도움이 되고자, PGS 1에서 얻은 바탕으로 경기 정보를 만들어 보았습니다.")
st.markdown(' ')
st.markdown(' ')
