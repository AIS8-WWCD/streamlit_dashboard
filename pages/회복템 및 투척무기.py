...
choice_1 = st.selectbox("원하시는 정보를 선택해서 확인해주세요", ('선택해 주세요','총 얻은 회복템', '총 얻은 투척 무기'))
...
st.markdown(' ')
# 팀 선택
team_name = st.selectbox("원하시는 팀을 선택해 주세요", ('17', '4AM', 'ACE', 'CES', 'DAY', 'DNW', 'EXO', 'FaZe',
        'GBL', 'GEN', 'GEX', 'HOWL', 'III', 'LG', 'NAVI', 'NH', 'PLM', 'PTG',
        'PeRo', 'SQ', 'SST', 'STK', 'TWIS', 'Tian'))
st.markdown(' ')
choice = st.selectbox("원하시는 정보를 선택해서 확인해주세요", ('선택해 주세요','총 얻은 아이템', '총 사용한 아이템' , '아이템 사용률'))
