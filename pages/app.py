...
# 데이터 불러오기
df_use_gun = pd.read_csv("df_handgun_weapon.csv")
df_handgun_weapon = pd.read_csv("df_handgun_weapon.csv")
df_throwable_weapon = pd.read_csv("df_throwable_weapon.csv")
df_parts_value = pd.read_csv("df_parts_value.csv")
df_upper = pd.read_csv("df_upper.csv")
df_Muzzle = pd.read_csv("df_Muzzle.csv")
df_Stock = pd.read_csv("df_Stock.csv")
df_use_gun = pd.read_csv("df_use_gun.csv")
df_Lower = pd.read_csv("df_Lower.csv")
df_Magazine = pd.read_csv("df_Magazine.csv")
df_move_distance_mean = pd.read_csv("df_move_distance_mean.csv")
df_survive_mean = pd.read_csv("df_survive_mean.csv")
